...
Funcionalidade: Produtos
    ...
    Cenário: Escolher um produto existente
    ...
    Cenário: Estar na página do produto escolhido
    ...
    Cenário: Adicionar ao Cart um produto existente pelo Search
    ...
    Cenário: Estar na página do Cart 
    ...
    Então o usuário deverá visualizar as informaçôes do "<produto>": "<description>" "<avail" "<unit_price>" "<qty>" 
    "<total>" "<delete>" "<total_products>"  "<total_shipping>" "<total>" "<tax>" "<total>"
